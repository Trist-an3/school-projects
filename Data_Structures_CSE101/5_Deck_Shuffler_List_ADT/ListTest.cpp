...
/*
   ...
   cout << "doing findNext now" << endl;
   cout << B.findNext(5) << endl;
   cout << "ok something happened" << endl;
   cout << B << endl;
   cout << "ok done" << endl;
   ...
   cout << B.position() << endl;
   cout << "Everything works for this part" << endl;

   cout << "\nNext loop stuff" << endl;
   for( i=10; i>=1; i--){
      A.insertAfter(i);
      A.movePrev();
   }
...
A.insertBefore(1);
std::cout << "Position after insertBefore(1): " << A.position() << std::endl;

A.insertBefore(2);
std::cout << "Position after insertBefore(2): " << A.position() << std::endl;
...
A.insertBefore(3);
std::cout << "Position after insertBefore(3): " << A.position() << std::endl;

A.insertBefore(1);
std::cout << "Position after insertBefore(1): " << A.position() << std::endl;

A.findPrev(3);
std::cout << "Position after findPrev(3): " << A.position() << std::endl;

A.cleanup();
std::cout << "Position after cleanup(): " << A.position() << std::endl;
